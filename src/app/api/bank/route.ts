...
export async function GET() {
  try {
    ...
    return NextResponse.json({
      ...
      accountNumberMasked: bankDetails?.accountNumber ? maskAccount(bankDetails.accountNumber) : null,
...
export async function PUT(req: NextRequest) {
  try {
    ...
    const encryptedAccountNumber = accountNumber ? encryptPII(accountNumber) : undefined;
